...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull RelativeLayout rootView, @NonNull Button backButton) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapsBinding((RelativeLayout) rootView, backButton);
    }

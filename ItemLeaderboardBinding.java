...
public final class ItemLeaderboardBinding implements ViewBinding {
  ...
  private ItemLeaderboardBinding(@NonNull CardView rootView, @NonNull ImageView ivUserAvatar,
  ...
  public static ItemLeaderboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLeaderboardBinding((CardView) rootView, ivUserAvatar, tvUserName,
          tvUserPoints);
    }
